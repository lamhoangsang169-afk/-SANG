...
# Hàm nạp lại dữ liệu từ file storage vào session state để đồng bộ real-time
...
# Đảm bảo đồng bộ ngầm liên tục mỗi khi có tương tác
sync_from_storage()
...
# Sử dụng st.fragment tự động đồng bộ real-time mỗi 3 giây giúp máy tính tự cập nhật ngay khi điện thoại thay đổi dữ liệu
...
# Gọi fragment để giao diện tự động đồng bộ real-time
render_main_content()
