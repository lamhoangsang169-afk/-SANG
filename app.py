...
# 1. Định nghĩa toàn bộ CSS giao diện cố định ngoài luồng fragment
st.markdown(f"""
<style>
    .stApp {{
        {bg_style}
...
# 2. Xây dựng cấu trúc Sidebar cố định chứa Ảnh đại diện và Menu chức năng
with st.sidebar:
...
# 3. Hàm hiển thị nội dung chính tự động làm mới ngầm mượt mà mỗi 5 giây
...
# Kích hoạt render phần nội dung chính
render_main_content()
