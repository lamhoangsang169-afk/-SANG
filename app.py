...
# Cố gắng import thư viện tự động refresh nếu có sẵn
try:
...
# Sử dụng decorator @st.fragment để ứng dụng tự động làm mới phần dữ liệu 
# ngầm mượt mà mỗi 5 giây mà KHÔNG làm chớp toàn bộ màn hình hoặc mất form nhập liệu.
...
# Gọi hàm hiển thị giao diện động mượt mà, loại bỏ hiện tượng nháy màn hình
render_main_content()
